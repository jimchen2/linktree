...
export const links: Link[] = [
  ...
  { name: "README.md", icon: "docker.svg", url: "./self-hosted", category: "Apps" },
  ...
  { name: "Server Status", icon: "grafana.png", url: "https://grafana.jimchen.me/public-dashboards/b6c9b0826c0b4af6b7bd4324618c5b95", category: "Fediverse" },
